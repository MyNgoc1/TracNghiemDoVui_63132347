...
public class PythonActivity extends AppCompatActivity {
    ...
    private String[] questions = {"Ngôn ngữ lập trình nào được sử dụng để viết Python?", "Hàm nào được sử dụng để nhập dữ liệu từ người dùng trong Python?", "Toán tử nào được sử dụng để ghép chuỗi trong Python?",};
    private String[][] answers = {
            {"Java", "C++", "C#", "Không có ngôn ngữ cụ thể nào"},
            {"print()", "input()", "len()", "type()"},
            {"+", "*", "/", "-"}

    };
    private int[] correctAnswerIndexes = {3, 1, 0};
