...
public class HtmlActivity extends AppCompatActivity {
    ...
    private String[] questions = {"Thẻ HTML nào được sử dụng để tạo tiêu đề?", "Thẻ nào trong HTML được sử dụng để tạo danh sách?", "Thuộc tính nào trong HTML được sử dụng để chỉ định liên kết?",};
    ...
    private int[] correctAnswerIndexes = {1, 3, 1};
